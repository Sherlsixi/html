...
axios({
  ...
  const provinceStr = result.data.list
    .map((pname) => {
      return `
  ...
  document.querySelector(".province").innerHTML =
    '<option value="">省份</option>' + provinceStr;
});
document.querySelector(".province").addEventListener("change", async (e) => {
  ...
  // console.log(result.data.list);
  const cityStr = result.data.list
    .map((cname) => {
      return `
  ...
  document.querySelector(".city").innerHTML =
    '<option value="">城市</option>' + cityStr;
...
//   console.log(result);
//   const optionStr = result.data.list
//     .map((aname) => `<option value="${aname}">${aname}</option>`)
//     .join("");
//   console.log(optionStr);
//   document.querySelector(".area").innerHTML =
//     `<option value="">地区</option>` + optionStr;
// });
